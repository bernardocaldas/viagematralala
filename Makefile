...
server: server.o yasc.o stack.o fifo.o pool.o manager.o
	$(CC) $(CFLAGS) -g -o bin/server obj/server.o obj/yasc.o obj/stack.o obj/fifo.o obj/pool.o obj/manager.o $(BIBS)
